 ...
 * @param {shouldShorten} shouldShorten a boolean value deciding whether or not to shorten the address
 * @returns Either a string address or the address in shortened form.
 */
export const lookupAddressName = (address, addressBook, shouldShorten = true) => {
